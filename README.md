...
* Для сервера с общим контентом - 2 сетевые карты по 25 Гбит/сек
  * Для сервера с популярным контентом - 2 сетевые карты по 50 Гбит/сек

Количество: 

* Сервера с общим контентом - 40% * 51562 Гбит/сек / (50 * 2) = 413 * 2 (по реплике на каждый) = 825
  * Сервера с популярным контентом - 60% * 51562 Гбит/сек / (100 * 2) = 310 * 3 = 620
