...
Для бэкенда будем использовать микросервисную архитектуру, написанную на Golang для обеспечения эффективной ассинхронной работы. В межсервисном взаимодействии будем использовать envoy для балансировки. Все взаимодействие будет происходить посредством grpc. В качестве аркестратора - k8s. 
